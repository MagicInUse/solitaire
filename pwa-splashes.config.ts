...
// Generates ONLY Apple splash screens from the full-bleed splash artwork (splash.png).
// App icons and favicon are generated by pwa-assets.config.ts from favicon.png.
